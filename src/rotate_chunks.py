...
def rotate90(chunk, name, axis, show=False):
...
def rotate_chunk(chunk, name, show=False):
    ...
    rotate90(chunk, name+['y'], (0,2), show)
    # Turn upside down looking at the floor '-y' and rotate bed clockwise
    rotate90(np.rot90(chunk, 2, (2,1)), name+['-y'], (2,0), show)
    ...
    rotate90(chunk, name+['x'], (1,0), show)
    # Turns around and another cart-wheel
    rotate90(np.rot90(chunk, 2, (2,0)), name+['-x'], (0,1), show)
    ...
    rotate90(chunk, name+['z'], (2,1), show)
    # Turns around and another cart-wheel
    rotate90(np.rot90(chunk, 2, (2,0)), name+['-z'], (1,2), show)
